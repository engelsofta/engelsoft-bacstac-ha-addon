...
## **API V2 BETA — Same BACnet, now with an actual conversation**

> **Important:** This beta introduces the new **API V2** integration protocol.
...
## Compatibility
- Kept the existing API V1 endpoints and WebSocket channel available during the beta migration.
